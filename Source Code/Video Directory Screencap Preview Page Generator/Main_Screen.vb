...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        CType(Me.example2, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.example3, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.example6, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.example4, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.example7, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.example5, System.ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.example8, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.Label9.Text = "BUILD 20060420.4"
        ...
        Me.Panel1.Size = New System.Drawing.Size(784, 562)
        ...
        Me.example10.ForeColor = System.Drawing.Color.DarkGreen
        ...
        Me.Panel3.ForeColor = System.Drawing.Color.DarkGreen
        ...
        Me.PictureBox1.Size = New System.Drawing.Size(1024, 670)
        ...
        CType(Me.example2, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.example3, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.example6, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.example4, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.example7, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.example5, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.example8, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        Try
            ...
            If tinfo.Exists = True Then
                ...
                While filereader.Peek > -1
                    ...
                    End If
                    If lineread.StartsWith("Page_TitleColour=") = True Then
                        lineread = lineread.Replace("Page_TitleColour=", "")
                        Dim R, G, B As Double
                        R = Val("&H" + Mid$(lineread, 2, 2))    ' Value 170 
                        G = Val("&H" + Mid$(lineread, 4, 2))   ' Value 255 
                        B = Val("&H" + Mid$(lineread, 6, 2))    ' Value 255 
                        Label1.ForeColor = Color.FromArgb(R, G, B)
                    End If
                    If lineread.StartsWith("Page_VideosLocatedColour=") = True Then
                        lineread = lineread.Replace("Page_VideosLocatedColour=", "")
                        Dim R, G, B As Double
                        R = Val("&H" + Mid$(lineread, 2, 2))    ' Value 170 
                        G = Val("&H" + Mid$(lineread, 4, 2))   ' Value 255 
                        B = Val("&H" + Mid$(lineread, 6, 2))    ' Value 255 
                        VideoFilesFound.ForeColor = Color.FromArgb(R, G, B)
                    End If
                    If lineread.StartsWith("Page_ControlsColour=") = True Then
                        lineread = lineread.Replace("Page_ControlsColour=", "")
                        Dim R, G, B As Double
                        R = Val("&H" + Mid$(lineread, 2, 2))    ' Value 170 
                        G = Val("&H" + Mid$(lineread, 4, 2))   ' Value 255 
                        B = Val("&H" + Mid$(lineread, 6, 2))    ' Value 255 
                        Panel3.ForeColor = Color.FromArgb(R, G, B)
                        Label13.ForeColor = Color.FromArgb(R, G, B)
                        ListBox1.ForeColor = Color.FromArgb(R, G, B)
                        Label10.ForeColor = Color.FromArgb(R, G, B)
                    End If
                    If lineread.StartsWith("Page_VideoDetailsColour=") = True Then
                        lineread = lineread.Replace("Page_VideoDetailsColour=", "")
                        Dim R, G, B As Double
                        R = Val("&H" + Mid$(lineread, 2, 2))    ' Value 170 
                        G = Val("&H" + Mid$(lineread, 4, 2))   ' Value 255 
                        B = Val("&H" + Mid$(lineread, 6, 2))    ' Value 255 
                        Panel1.ForeColor = Color.FromArgb(R, G, B)
                        example10.ForeColor = Color.FromArgb(R, G, B)
                    End If
                    If lineread.StartsWith("Page_BuildColour=") = True Then
                        lineread = lineread.Replace("Page_BuildColour=", "")
                        Dim R, G, B As Double
                        R = Val("&H" + Mid$(lineread, 2, 2))    ' Value 170 
                        G = Val("&H" + Mid$(lineread, 4, 2))   ' Value 255 
                        B = Val("&H" + Mid$(lineread, 6, 2))    ' Value 255 
                    ...
                    End If
                    If lineread.StartsWith("Page_MainPanelColour=") = True Then
                        lineread = lineread.Replace("Page_MainPanelColour=", "")
                        Dim R, G, B As Double
                        R = Val("&H" + Mid$(lineread, 2, 2))    ' Value 170 
                        G = Val("&H" + Mid$(lineread, 4, 2))   ' Value 255 
                        B = Val("&H" + Mid$(lineread, 6, 2))    ' Value 255 
            ...
            Dim bginfo As FileInfo = New FileInfo((dinfo.FullName & "\backdrop.jpg").Replace("\\", "\"))
            If bginfo.Exists = True Then
                Me.BackgroundImage = Image.FromFile(bginfo.FullName)
            End If
            bginfo = Nothing

            bginfo = New FileInfo((dinfo.FullName & "\paneldrop.jpg").Replace("\\", "\"))
            If bginfo.Exists = True Then
                Panel1.BackgroundImage = Image.FromFile(bginfo.FullName)
            ...
            For Each finfo In dinfo.GetFiles()
                ...
                End If
            Next
            If IsNumeric(VideoFilesFound.Text) = True Then
                If CInt(VideoFilesFound.Text) = 1 Then
                    VideoFilesFound.Text = VideoFilesFound.Text & " Video File Located"
                Else
